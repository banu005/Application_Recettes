...
class TestAjouterRecette(unittest.TestCase):
    ...
    def test_ajouter_doublon_leve_exception(self):
        # Test qu'un doublon lève DoublonRecetteError.
        doublon = Recette("Omelette", ["oeuf"], "Battre les oeufs et cuire à feu doux.")
        with self.assertRaises(DoublonRecetteError):
            ajouter_recette(self.recettes, doublon)
